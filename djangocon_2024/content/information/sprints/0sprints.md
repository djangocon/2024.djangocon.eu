...
<div>
    <img id="myImg1" src="/static/images/sprints/sprints.png" style="width: 100%;"/>
</div>
...
#### Main Venues - Hosting our Sprints

- [**Auditorio Mar de Vigo**](https://auditoriomardevigo.com/){:target="\_blank"}
...
<div class="row">
    <div class="col-md-6">
        <div style="overflow:hidden;resize:none;max-width:100%;width:500px;height:500px;">
            ...
            <h5><strong>Auditorio Mar de Vigo</strong></h5>
                <iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=Mar+de+Vigo+Auditorium&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe>
            </div>
